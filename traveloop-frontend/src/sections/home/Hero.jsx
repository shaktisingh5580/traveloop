      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
          ...
          <form onSubmit={handleSearch} className="max-w-[700px] w-full bg-white p-2 rounded-[3.5rem] shadow-2xl border border-slate-100 flex flex-col md:flex-row items-center gap-1 group">
            ...
            {/* Action Button */}
            <button type="submit" className="bg-slate-900 text-white w-14 h-14 rounded-full flex items-center justify-center hover:bg-emerald-500 transition-all shadow-xl active:scale-95 shrink-0 group-hover:w-32 group-hover:gap-2 overflow-hidden transition-[width]">
               ...
               <span className="hidden group-hover:block font-bold text-sm whitespace-nowrap">Plan Trip</span>
            </button>
          </form>
